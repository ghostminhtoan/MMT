@echo off
title File Extension Manager - Assoc/Unassoc
color 0A
...
echo [2] Unassociate File Extension
echo [3] Exit
echo.
...
echo.
echo Confirm: Remove association for [!file_ext!]?
choice /c YN /m "Continue (Y/N)?"
if errorlevel 2 goto MAIN_MENU
...
echo.
echo ✅ Success: [!file_ext!] association has been removed.
pause
goto MAIN_MENU